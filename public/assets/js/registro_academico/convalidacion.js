$(document).ready(function () {
    ...
    $('#myModalGeneral').on('show.bs.modal', function(e) {
        ...
        if(action == "asignatura_nueva") {
            ...
            $('.modal-title').html("Crear Asignatura a Convalidar");
    
            $.post(
                'mantenedores/registro_academico/convalidacion_action.php', 
                {
            ...
            $.post(
                ...
                function(data) {
                    if(data == 0) {
                        ...
                        $("#respuesta").html("<br><div class='alert alert-danger alert-dismissible text-center'>El alumno ya se encuentra inscrito de manera regular, por favor eliminar inscripción antes de Convalidar</div>");
                    } else if(data == 2) {
