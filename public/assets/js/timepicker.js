...
(function($){
  ...
  function _createTimepicker($input){
    ...
    hour_header.className = "text-center col-md-6";
    min_header.className = "text-center col-md-6";
    ok_button.className = "col-md-6 btn btn-success btn-outline ok-button";
    cancel_button.className = "col-md-6 btn btn-danger btn-outline cancel-button";

    if (settings.use12HourClock){
      // if using 12-hour clock, widen the picker to 18rem
      // and create am/pm button
      $(picker).css("width", "19.2rem");
      hour_header.className = "text-center col-md-5";
      min_header.className = "text-center col-md-5";
      hour_select.className = "form-control col-md-5 hour-select";
      min_select.className = "form-control col-md-5 min-select";
      ...
      ampm_button_wrapper.className = "col-md-2 my-auto";
    }
    else{
      // default width of the picker is 12rem
      $(picker).css("width", "19rem");
      hour_select.className = "form-control col-md-6 hour-select";
      min_select.className = "form-control col-md-6 min-select";
    }
